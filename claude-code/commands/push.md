...
**For [Your Company] Team Bitbucket (bitbucket.org/[your-team]):**
- Detect remote URL contains `bitbucket.org/[your-team]` 
- Set: `git config user.email [team-member]@[your-company].com`
