...
This guide covers essential PDF processing operations using Python libraries and command-line tools. For advanced features, JavaScript libraries, and detailed examples, see references/advanced-features.md. If you need to fill out a PDF form, read references/forms.md and follow its instructions.

**Creating fillable forms:** To create interactive PDF forms with clickable checkboxes and typeable text fields, see references/creating-fillable-pdfs.md. This guide also covers how to create blank fillable templates from filled-in examples (reverse-engineering workflow).
...
| Create fillable forms | reportlab AcroForm | See references/creating-fillable-pdfs.md |
| Create blank from filled | reportlab AcroForm | See references/creating-fillable-pdfs.md#creating-blank-templates |
...
- To fill out an existing PDF form, follow the instructions in references/forms.md
