...
| Differentiation | Pass | Specialized [Your Company] domain knowledge and 5-test validation framework |
...
3. **Building a Sukuk Compliance Review Gem**
   ...
   - Output: Canvas displays Islamic finance gem taking shape with technical PERSONA, compliance TASK, [Product] CONTEXT

---

## Recommended File Attachments

No file attachments needed - all methodology, examples, templates, and business context are embedded in the gem instructions.

**Optional Enhancement Attachments:**
- **Brand Style Guide** (if creating content gems): For tone, terminology, visual standards
- **Regulatory Framework Summary** (if creating compliance gems): For jurisdiction-specific requirements
...
6. Share with [Your Company] team via Google Workspace
